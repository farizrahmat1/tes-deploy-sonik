...
const Widget = ({ type,kwhdata,chargestoday,activecs,transactiontoday,registeredcs,connectedcs }) => {
  let data;
  const howMany = false;
  const isMoney = false;
    ...
    <div className="widget">
      <div className="left">
        ...
        <div className="counter">
          {howMany} {transactiontoday}
        </div>
        <div className="counter">
          {howMany} {chargestoday}
        </div>
        <div className="counter-registeredcs">
          {howMany} {registeredcs}
        </div>
